...
main = shakeArgs shakeOptions $ do
    want [-- Web API
         ...
         , "out/work/ids/kegg-to-chebi.json"
          -- Figs
         , "out/fig/without-outliers/pca-global-pop.pdf"
         , "out/fig/without-outliers/pca-categorized-primary.pdf"
         , "out/fig/without-outliers/pca-categorized-lipids.pdf"
         , "out/fig/without-outliers/pca-categorized-legend.pdf"
--          , "out/fig/without-outliers/orotic-acid-plot.pdf"
         , "out/fig/without-outliers/sugar-phosphate-plot.pdf"
         , "out/fig/without-outliers/sugar-phosphate-heatmap.pdf"
         ...
         , "out/work/primary/opls/without-outliers/Nucleotides/Muscle/Pachon/30vR.csv" -- OPLS primary starvation response
         , "out/work/primary/glm/singlefactor/without-outliers/Nucleotides/Muscle/CvS/30vR.csv" -- GLM primary cross-pop
         ...
         , "out/supp/without-outliers/primary-pop-compare-significance.xlsx"
         , "out/fig/without-outliers/ratios-combined.pdf"
         , "out/work/lipids/opls/without-outliers/category/Sphingolipids/Muscle/Ref/PvT.csv" -- Lipid OPLS
         , "out/work/lipids/glm/singlefactor/without-outliers/Muscle/Ref/PvT.csv" -- Lipid GLM
         , "out/work/lipids/glm/singlefactor/without-outliers/Muscle/Pachon/30vR.csv" -- Lipid GLM (compare conditions)
         , "out/work/lipids/opls/without-outliers/category/Sphingolipids/Muscle/Pachon/30vR.csv" -- Lipid OPLS for condition comparison
         , "out/work/lipidcats/opls/without-outliers/Liver/Ref/Classes/PvT.csv" -- Lipid cats/classes OPLS
         , "out/work/lipidcats/glm/without-outliers/Muscle/Ref/Categories/PvT.csv" -- Lipid cats/classes GLM
         ]
...
--       cmd_ (AddEnv "PYTHONPATH" "./src/python") "pipenv run python3 ./src/python/orotic-acid-plot.py --astyanax ./data/primary/metabolomics-corrected.csv --compounds ./data/kegg/compounds.json --hmdb ./data/hmdb/hmdb.json --exclude-outlier False --output ./out/fig/without-outliers/orotic-acid-plot.pdf"
    ...
    "out/work/primary/glm/singlefactor/without-outliers/Nucleotides/Muscle/Ref/PvT.csv" %> \out -> do
      need [primary_src, "src/R/glm/primary-pop-compare.R", "out/work/primary/opls/without-outliers/Nucleotides/Muscle/Ref/PvT.csv"]
      cmd_ "Rscript ./src/R/glm/primary-pop-compare.R"

    -- OPLS primary starvation response
    "out/work/primary/opls/without-outliers/Nucleotides/Muscle/Pachon/30vR.csv" %> \out -> do
    ...
    "out/work/primary/glm/singlefactor/without-outliers/Nucleotides/Muscle/Pachon/30vR.csv" %> \out -> do
      need ["src/R/glm/primary-cond-compare.R", "out/work/primary/opls/without-outliers/Nucleotides/Muscle/Ref/PvT.csv"]
      cmd_ "Rscript ./src/R/glm/primary-cond-compare.R"

    -- GLM primary starvation response
    "out/work/primary/glm/singlefactor/without-outliers/Nucleotides/Muscle/CvS/30vR.csv" %> \out -> do
      need ["src/R/glm/primary-starvation-response.R", "out/work/primary/opls/without-outliers/Nucleotides/Muscle/Pachon/30vR.csv"]
    ...
    "out/supp/without-outliers/primary-pop-compare-significance.xlsx" %> \out -> do
      need ["src/python/tables/primary-pop-compare.py", "out/work/primary/glm/singlefactor/without-outliers/Nucleotides/Muscle/Ref/PvT.csv"]
      cmd_ (AddEnv "PYTHONPATH" "./src/python") "pipenv run python3 ./src/python/tables/primary-pop-compare.py --outlier without-outliers --level 0.05 --output out/supp/without-outliers/primary-pop-compare-significance.xlsx"

    "out/fig/without-outliers/ratios-combined.pdf" %> \out -> do
      need [primary_src, "src/python/ratio-plot-combined.py"]
      cmd_ (AddEnv "PYTHONPATH" "./src/python") "pipenv run python3 ./src/python/ratio-plot-combined.py --astyanax ./data/primary/metabolomics-corrected.csv --compounds ./data/kegg/compounds.json --hmdb ./data/hmdb/hmdb.json --sample-sheet ./data/primary/sample-sheet.csv --lipids-normalized ./data/lipids/normalized --lipidmaps-fa ./data/lipidmaps/lipidmaps-20200724-sat-unsat-fas.json --lipidmaps-json ./data/lipidmaps/lipidmaps-20200724.json --output ./out/fig/without-outliers/ratios-combined.pdf --output-legend ./out/fig/without-outliers/ratios-combined-legend.pdf"

    -- OPLS lipids compare pop
    "out/work/lipids/opls/without-outliers/category/Sphingolipids/Muscle/Ref/PvT.csv" %> \out -> do
    ...
    "out/work/lipids/glm/singlefactor/without-outliers/Muscle/Ref/PvT.csv" %> \out -> do
      need ["src/R/glm/lipids-pop-compare.R", "out/work/lipids/opls/without-outliers/category/Sphingolipids/Muscle/Ref/PvT.csv"]
      cmd_ "Rscript ./src/R/glm/lipids-pop-compare.R"

    -- OPLS lipids compare condition
    "out/work/lipids/opls/without-outliers/category/Sphingolipids/Muscle/Pachon/30vR.csv" %> \out -> do
    ...
    "out/work/lipids/glm/singlefactor/without-outliers/Muscle/Pachon/30vR.csv" %> \out -> do
      need ["src/R/glm/lipids-cond-compare.R", "out/work/lipids/opls/without-outliers/category/Sphingolipids/Muscle/Pachon/30vR.csv"]
      cmd_ "Rscript ./src/R/glm/lipids-cond-compare.R"

    -- OPLS lipid cats
    "out/work/lipidcats/opls/without-outliers/Liver/Ref/Classes/PvT.csv" %> \out -> do
    ...
    -- GLM lipid cats
    "out/work/lipidcats/glm/without-outliers/Muscle/Ref/Categories/PvT.csv" %> \out -> do
      need ["src/R/glm/lipid-cats-pop-compare.R", "out/work/lipidcats/opls/without-outliers/Liver/Ref/Classes/PvT.csv"]
