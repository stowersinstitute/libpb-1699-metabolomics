...
pichai2 = Person(name='Sundar Pichai2',
                type=PersonType.business,
                company=google,
                email_address='sundar2@google.com',
                phone_number='2650-253-0000',
                address=google.address)

Writer().run('/tmp/y/*.csv', [pichai,google], models=[Address,Company,Person], write_toc=True, write_schema=True)
